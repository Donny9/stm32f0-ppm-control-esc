...
// USART Force reset
#define __USARTx_FORCE_RESET(x)                  \
 ((x == USART1) ? RCC->APB2RSTR |= (1U << 14)  : \
  (x == USART2) ? RCC->APB1RSTR |= (1U << 17)  : \
  (x == USART3) ? RCC->APB1RSTR |= (1U << 18)  : \
  (x == UART4)  ? RCC->APB1RSTR |= (1U << 19)  : \
  (x == UART5)  ? RCC->APB1RSTR |= (1U << 20)  : \
  0)

// USART Release reset
#define __USARTx_RELEASE_RESET(x)                \
 ((x == USART1) ? RCC->APB2RSTR &= ~(1U << 14) : \
  (x == USART2) ? RCC->APB1RSTR &= ~(1U << 17) : \
  (x == USART3) ? RCC->APB1RSTR &= ~(1U << 18) : \
  (x == UART4)  ? RCC->APB1RSTR &= ~(1U << 19) : \
...
#define __USARTx_CLK_ENABLE(x)                   \
 ((x == USART1) ? RCC->APB2ENR  |=  (1U << 14) : \
  (x == USART2) ? RCC->APB1ENR  |=  (1U << 17) : \
  (x == USART3) ? RCC->APB1ENR  |=  (1U << 18) : \
  (x == UART4)  ? RCC->APB1ENR  |=  (1U << 19) : \
  (x == UART5)  ? RCC->APB1ENR  |=  (1U << 20) : \
  0)
